          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              },
              {
                ...
                description: "Indicate your dietary restrictions and allergens when searching. The app automatically ensures recipes are safe and suitable for your specific needs, prioritizing safety for complex dietary requirements.",
                icon: (
                  <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
